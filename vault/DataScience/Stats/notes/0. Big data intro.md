...
`Input -> splitting -> mapping (key:value) -> suffeling/organise -> reducing -> final result`
...
it reduce the hadoop struggle of manuall read and write on each hadoop disk
replacing manual Disk-I/O management with rich, developer-friendly APIs and automated **DAG optimization**
