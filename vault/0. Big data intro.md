...
3. rack awareness: rack is the  thousands of computers (nodes) are physically grouped together into **racks**. and hdfs stores a data copy in different racks so  the  data is not lost and quick to access for user by connecting to closest rack 
