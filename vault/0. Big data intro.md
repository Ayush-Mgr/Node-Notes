...
it is an distributed storage system for parallel access and control of the data
where Name Node stores meta data of the data nodes infos and how much data stored in which data nodes.
